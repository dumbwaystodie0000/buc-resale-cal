    ...
    <tr className="bg-[#F8F9FA]" data-oid="v3xvgj_">
      ...
      >
        <div className="flex items-center gap-2" data-oid=".z5h3mv">
          {icon && (
            <i
              className={`bi bi-${icon} text-[#666666] text-lg`}
              data-oid="--w-qt_"
            ></i>
          )}
    ...
    <tr className="hover:bg-[#F8F9FA]" data-oid="ifl4wdv">
      ...
      {properties.map((p, i) => {
        ...
        return (
          ...
          >
            {isNA ? (
              <div className="text-xs text-[#999999]" data-oid="1tnp_t1">
                N/A
              </div>
            ) : (
              renderInput(p)
    ...
    <tr className="hover:bg-[#F8F9FA]" data-oid="sxvv-et">
      ...
      >
        <div className="flex items-center gap-2" data-oid="itx8yac">
          <Icon className="h-4 w-4 text-[#666666]" data-oid="q.do1so" />
          {label}
        </div>
      </td>
      {properties.map((p, i) => (
    ...
    <tr className="hover:bg-[#F8F9FA]" data-oid="sxvv-et">
      ...
      {properties.map((p, i) => {
        ...
        return (
          ...
          >
            {isNA ? (
              <div className="text-xs text-[#999999]" data-oid="37.yn:s">
                N/A
              </div>
            ) : (
    ...
    <tr className="hover:bg-[#F8F9FA]" data-oid=":7oj0y6">
      ...
      {properties.map((p, i) => {
        ...
        return (
          ...
          >
            {isNA ? (
              <div className="text-xs text-[#999999]" data-oid="fgioo-u">
                N/A
              </div>
            ) : (
              renderInput(p)
